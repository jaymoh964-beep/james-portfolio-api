...
<body>
  <div class="wrapper">
    <div class="header">
      ...
      <p>Someone reached out through jaymoh964@gmail.com</p>
    </div>
    <div class="body">
      <div class="field">
...
<body>
  <div class="wrapper">
    ...
    <div class="body">
      ...
      <a href="https://james-portfolio-api.onrender.com" class="cta">View My Portfolio →</a>
    </div>
    <div class="footer">
  ...
  try {
    ...
    return res.status(500).json({ success: false, message: 'Failed to send message. Please email directly: jaymoh964@gmail.com or WhatsApp +254771442830' });
  }
});
